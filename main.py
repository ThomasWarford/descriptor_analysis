...
parser.add_argument("work_dir", help="directory containing .model file. Directory name should be ... model",
                    type=str)
parser.add_argument("dataset", help="choice of dataset",
                    choices=['mptrj', 'salex',], type=str)
parser.add_argument("calculate_residual", help="save the residual error for the config",
                    type=bool)
...
def main(args):
    ...
    model = mace_mp('/lustre/fswork/projects/rech/gax/ums98bp/.models/MACE-matpes-r2scan-omat-ft.model', device=device, return_raw_model=True)
    ...
    save_descriptors(
        model,
        dataloader,
        Path('/lustre/fswork/projects/rech/gax/ums98bp/descriptor_analysis/testsalex'),
        device,
    )
